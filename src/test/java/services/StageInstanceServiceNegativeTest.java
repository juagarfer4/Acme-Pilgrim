...
public class StageInstanceServiceNegativeTest extends AbstractTest {
	...
	// Crear una instancia de etapa con fecha final anterior a la inicial. ----------
	
	@Test(expected=java.lang.IllegalArgumentException.class)
	public void testNegativeCreateStageInstance(){
		...
		startingMoment=new Date(2014 - 1900, 11 - 1, 13);
		endingMoment=new Date(2014 - 1900, 11 - 1, 11);
